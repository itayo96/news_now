...
namespace NewsNow.Migrations
{
    ...
    [Migration("20181021221252_Users")]
    partial class Users
    {
...
", DateCreated = new DateTime(2018, 10, 22, 1, 12, 51, 665, DateTimeKind.Local), Header = "Iran blames US and Saudi Arabia for terror attack", HomeImageUrl = "https://images.jpost.com/image/upload/f_auto,fl_lossy/t_Article2016_ControlFaceDetect/427101", IsShowMap = true, Location = "טהרן, אירן", Summery = "Iran blames the US and Saudi Arabia for military parade terror attack" },
...
*""The terrorists disguised as Islamic Revolution Guards Corps and Basij (volunteer) forces opened fire to the authority and people from behind the stand during the parade,""* said Gholam-Reza Shariati, governor of Khuzestan province, according to IRNA.
Khuzestan is a province that borders Iraq and has a large ethnic Arab community, many of them Sunni. It was a major battleground during the Iran-Iraq War that killed half a million soldiers in the '80s.
", DateCreated = new DateTime(2018, 10, 22, 1, 12, 51, 667, DateTimeKind.Local), Header = "Gilad Erdan: Israel making progess against Terror", HomeImageUrl = "https://images.jpost.com/image/upload/f_auto,fl_lossy/t_TopStoryMainImageFaceDetect/429944", IsShowMap = false, Location = "תל אביב, ישראל", Summery = "Erdan is responsible for the fight against BDS in the Strategic Affairs Ministry, and the steps he has taken in that battle are controversial and unconventional." },
...
*""The terrorists disguised as Islamic Revolution Guards Corps and Basij (volunteer) forces opened fire to the authority and people from behind the stand during the parade,""* said Gholam-Reza Shariati, governor of Khuzestan province, according to IRNA.
Khuzestan is a province that borders Iraq and has a large ethnic Arab community, many of them Sunni. It was a major battleground during the Iran-Iraq War that killed half a million soldiers in the '80s.
", DateCreated = new DateTime(2018, 10, 22, 1, 12, 51, 667, DateTimeKind.Local), Header = "Trails and Tribulations of Eurovision 2019, What to expect next?", HomeImageUrl = "https://images.jpost.com/image/upload/f_auto,fl_lossy/t_Article2016_ControlFaceDetect/429094", IsShowMap = false, Location = "תל אביב, ישראל", Summery = "For the next eight months, squabbles over politics, money and religion are bound to plague the upcoming Eurovision. But which arguments should be taken seriously?" },
...
*""The terrorists disguised as Islamic Revolution Guards Corps and Basij (volunteer) forces opened fire to the authority and people from behind the stand during the parade,""* said Gholam-Reza Shariati, governor of Khuzestan province, according to IRNA.
Khuzestan is a province that borders Iraq and has a large ethnic Arab community, many of them Sunni. It was a major battleground during the Iran-Iraq War that killed half a million soldiers in the '80s.
", DateCreated = new DateTime(2018, 10, 22, 1, 12, 51, 667, DateTimeKind.Local), Header = "Livinng out the Baha'i: A journy to israel", HomeImageUrl = "https://images.jpost.com/image/upload/f_auto,fl_lossy/t_Article2016_ControlFaceDetect/429990", IsShowMap = false, Location = "תל אביב, ישראל", Summery = "More than a million people visit the gardens every year. Apart from being at the holiest site of his faith..." },
...
*""The terrorists disguised as Islamic Revolution Guards Corps and Basij (volunteer) forces opened fire to the authority and people from behind the stand during the parade,""* said Gholam-Reza Shariati, governor of Khuzestan province, according to IRNA.
Khuzestan is a province that borders Iraq and has a large ethnic Arab community, many of them Sunni. It was a major battleground during the Iran-Iraq War that killed half a million soldiers in the '80s.
", DateCreated = new DateTime(2018, 10, 22, 1, 12, 51, 667, DateTimeKind.Local), Header = "BMW vision's for a self-driving electric car", HomeImageUrl = "https://i.cdn.turner.com/money/dam/assets/180913172656-bmw-inext-780x439.jpg", IsShowMap = false, Location = "תל אביב, ישראל", Summery = "BMW has unveiled its vision for a self-driving electric crossover SUV and, if it actually ends up being a lot like the concept." }
                    );
                });
            ...
            modelBuilder.Entity("NewsNow.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new { UserId = 1, Password = "letmein", Permissions = "Allowed", Username = "Isaac Garzoon" },
                        new { UserId = 2, Password = "password", Permissions = "Allowed", Username = "username" }
                    );
                });
